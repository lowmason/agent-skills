...
| Dirichlet-process mixture | K unknown and you want the model to infer it; nonparametric "infinite" mixture | Reach for this instead of scanning K when component count is the question, not a nuisance. | — / PML2 §31.1 | notebooks/book2/31/dp_mixgauss_cluster.ipynb |
