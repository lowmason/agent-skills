...
| Gaussian discriminant analysis / naive Bayes | Few examples per class, missing features, or need to add classes without retraining | Generative fallback; easy to fit by counting, handles missing inputs, but watch poor calibration from independence assumptions | PML1 §9.2–9.4 | notebooks/book1/09/discrim_analysis_dboundaries_plot2.ipynb |
