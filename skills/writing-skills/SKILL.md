...
**Personal skills live in your runtime's skills directory** — for Claude Code that's `~/.claude/skills/` (see the [Claude Code skills docs](https://code.claude.com/docs/en/skills)). Codex, Copilot CLI, and Gemini CLI use their own skills directories and also recognize `~/.agents/skills/` as a cross-runtime alias.
