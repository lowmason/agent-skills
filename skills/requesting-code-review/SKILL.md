...
- `[DIFF_FILE]` - Review-package path (from subagent-driven-development's `scripts/review-package PLAN_FILE BASE HEAD`); required when dispatched from that skill, optional otherwise
